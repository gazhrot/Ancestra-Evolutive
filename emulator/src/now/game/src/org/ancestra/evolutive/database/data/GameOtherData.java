...
public class GameOtherData extends AbstractDAO<Object>{

	public GameOtherData(HikariDataSource source) {
		super(source);
        logger = (Logger) LoggerFactory.getLogger("factory.GameOther");
	}
