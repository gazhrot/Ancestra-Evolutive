...
public class AccountPacket {
	...
	public static void parseAccountPacket(GameClient client, String packet)
	{
		switch(packet.charAt(1))
		{
			case 'A': 
				addCharacter(client, packet);
			break;
			case 'B':
				int stat = -1;
				try	{
	...
	private static void addCharacter(GameClient client, String packet) {
