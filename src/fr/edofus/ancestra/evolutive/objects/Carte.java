...
import fr.edofus.ancestra.evolutive.objects.job.JobConstant;
...
public class Carte {
	...
	public static class MountPark
	{
		...
		{
			for(Entry<Short, fr.edofus.ancestra.evolutive.objects.Carte.MountPark> mp : World.data.getMountPark().entrySet())//Pour chaque enclo si ils en ont plusieurs
			{
