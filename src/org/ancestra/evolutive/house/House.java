...
public class House
{
	...
	public void HopIn(Player P)//Entrer dans la maison
	{
		...
		if(h == null) return;
		if(h.get_owner_id() == P.getAccount().getUUID() || (P.getGuild() != null && P.getGuild().getId() == h.get_guild_id() && canDo(Constants.H_GNOCODE)))//C'est sa maison ou même guilde + droits entrer sans pass
		{
			OpenHouse(P, "-", true);
		}
