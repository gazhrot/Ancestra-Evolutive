...
public class Mount implements Serializable {
	...
	public void addExperience(long experience) {
		this.experience += experience;
		while(this.getExperience() >= World.data.getExpLevel(this.getLevel() + 1).mount && this.getLevel() < 100)
			levelUp();	
	}
	...
	public String parse() {
		...
		str.append(",").append(":");//FIXME capacit�s
	...
	private String parseXpString() {
		return this.getExperience() + "," + World.data.getExpLevel(this.getLevel()).mount + "," + World.data.getExpLevel(this.getLevel() + 1).mount;
	}
