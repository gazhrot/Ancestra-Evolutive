...
public class Fighter
{
	...
	public Fighter(Fight f, Collector Perco) {
		...
		_id = -1;
		_PDVMAX = (World.data.getGuild(Perco.get_guildID()).getLevel()*100);
		_PDV = (World.data.getGuild(Perco.get_guildID()).getLevel()*100);
		_gfxID = 6000;
	}
	...
	public String getGmPacket(char c)
	{
		...
		{
			case 1://Perso
				str.append(_perso.getClasse()).append(";");
